    ...
    public class ServiceConfig: IEntityTypeConfiguration<Service>
    {
        public void Configure(EntityTypeBuilder<Service> builder)
        {
            ...
            builder.HasData(
                ...
                new Service { Id = 25, BasePrice = 500, Name = "مراقبت و نگهداری", SubCategoryId = 13, ImagePath = "\\Images\\Services\\25.jpg", TimeCreated = new DateTime(2025, 10, 2) },
                new Service { Id = 26, BasePrice = 500, Name = "پرستاری و تزریقات", SubCategoryId = 13, ImagePath = "\\Images\\Services\\26.jpg", TimeCreated = new DateTime(2025, 10, 2) },
